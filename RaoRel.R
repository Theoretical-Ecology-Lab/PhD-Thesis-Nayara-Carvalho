...
#                                      
# INPUTS:                                                                                 
#	- "sample": matrix of abundances (c x s) of the s species for the c local communities (or samples)           
...
RaoRel<-function(sample, dfunc, dphyl, weight=F, Jost=F, structure=NULL)   {
  library(ade4)
